...
The idea, the civic framing, the country choices and the product decisions are the author's. AI coding tools were used to build, test and iterate the software. This log records how, so the working method can be judged rather than guessed.
