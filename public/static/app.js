...
function renderSettings() {
  ...
  app.innerHTML = `
    <section class="page-head compact-head"><div><span class="eyebrow">${t("settings_eyebrow")}</span><h1>${t("settings_title")}</h1><p>${t("settings_body")}</p></div></section>
    <section class="feedback-layout">
      <article class="panel">
        ...
        <label class="form-label" for="pref-language">${t("settings_language_label")}</label>
...
function renderExplain() {
  ...
  app.innerHTML = `
    <section class="page-head compact-head"><div><span class="eyebrow">${t("explain_eyebrow")}</span><h1>${t("explain_title")}</h1><p>${t("explain_body")}</p></div></section>
    <section class="feedback-layout">
      <article class="panel">
